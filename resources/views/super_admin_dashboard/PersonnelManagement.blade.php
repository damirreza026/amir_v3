<x-layouts::app :title="__('مدیریت پرسنل')">
    ...
    @php
        ...
        /*
        |--------------------------------------------------------------------------
        | دسترسی‌های این صفحه (مدیریت پرسنل: استخدام و پروفایل)
        |--------------------------------------------------------------------------
        | 1: سوپر ادمین
        | 2: ادمین
        */
        ...
        <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
            <div class="grid auto-rows-min gap-4 md:grid-cols-3">
                <div
                    ...
                    style="height: 280px !important; min-height: 380px !important;"
                >
                    <x-placeholder-pattern
                        class="absolute inset-0 size-full stroke-gray-900/20 dark:stroke-neutral-100/20"
                    />

                    <x-PersonnelManagement.recruitment />
                </div>
        ...
        <div class="flex min-h-[60vh] items-center justify-center px-4">
            <div class="w-full max-w-lg rounded-2xl border border-red-200 bg-red-50 p-8 text-center shadow-sm dark:border-red-500/20 dark:bg-red-500/10">
                ...
                <p class="mt-3 text-sm leading-7 text-red-600/80 dark:text-red-300/80">
                    شما اجازه دسترسی به صفحه مدیریت پرسنل را ندارید.
                </p>
